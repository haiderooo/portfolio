...
1) a histogram plot of the counts of comments per topic. See figure 1 below.
2) a distribution plot showing proportion of each topic per facebook page. See figure 2 below.
3) a csv each for each of the topics to show 10 representative comments for each topic.

Result 1: the count of comments per topic for -1 (noise) was 260, for 0 was 169, for 1 was 119 and for 2 was 85. See Table 1 below.

Figure 1: Histogram showing count of comments per topic
![a random image]({{site.baseurl}}images/hist_topic_counts.png)


Figure 2: Distribution plot showing proportions of topic for each page
![a random image]({{site.baseurl}}images/hist_topic_prop_source.png)

Table 1: Counts of comments per topic
![a random image]({{site.baseurl}}images/count.png)
